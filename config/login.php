...
if (isset($_SESSION["login"])) {
    if (isset($_SESSION['isAdmin'])) {
        header("Location: /Tracer-study-master/app/admin/akun_alumni.php");
    } else {
        header("Location: /Tracer-study-master/app/user/dashboard_user.php");
    }
    exit;
}
...
<head>
    ...
    <style>
        body {
            background: url('../app/img/siswa.jpeg');
...
<body style="background-color: #7289da; overflow: hidden;">
    <div class="container shadow">
        <div style="text-align: center;">
            <a href="../index.php"><img src="../app/img/logo.png" style="text-align: center; width: 125px;"></a>
