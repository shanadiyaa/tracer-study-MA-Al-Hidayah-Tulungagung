...
<body class="bg-light">
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['IPA', 'IPS', 'Keagamaan'],
                datasets: [{
                    label: '',
                    data: [
                        <?php $jumlah_ipa = mysqli_query($conn, "SELECT * FROM data_alumni WHERE jurusan_alumni = 'IPA'");
                        echo mysqli_num_rows($jumlah_ipa); ?>,
                        <?php $jumlah_ips = mysqli_query($conn, "SELECT * FROM data_alumni WHERE jurusan_alumni = 'IPS'");
                        echo mysqli_num_rows($jumlah_ips); ?>,
                        <?php $jumlah_agama = mysqli_query($conn, "SELECT * FROM data_alumni WHERE jurusan_alumni = 'Keagamaan'");
