                                        ...
                                        <tr>
                                            ...
                                            <td><select name="jurusan_alumni" value="<?= $akunalumni['jurusan_alumni'] ?>" required>
                                                    ...
                                                    <option value="IPA" <?php
                                                                                    if ($akunalumni['jurusan_alumni'] == "IPA")
                                                                                        echo 'selected' ?>>IPA</option>
                                                    <option value="IPS" <?php
                                                                                    if ($akunalumni['jurusan_alumni'] == "IPS")
                                                                                        echo 'selected' ?>>IPS</option>
                                                    <option value="Keagamaan" <?php
                                                                                    if ($akunalumni['jurusan_alumni'] == "Keagamaan")
                                                                                        echo 'selected' ?>>Keagamaan</option>
                                                </select>
                                            </td>
                                        </tr>
                                    ...
                                    <table>
                                        ...
                                        <div>
                                            <tr id="pendidikan1">
                                                ...
                                                <td>:</td>
                                                <td><input type="text" name="univ_lanjut" value="<?= $akunalumni['univ_lanjut'] ?>" <?php $akunalumni['lanjut_pendidikan'] == "Tidak" ? 'disabled' : ''?>></td>
                                            </tr>
                                            <tr id="pendidikan2">
