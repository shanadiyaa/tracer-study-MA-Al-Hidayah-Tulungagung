...
$dataalumni = query("SELECT * FROM data_alumni ORDER BY nim ASC");

if (isset($_POST["cari"])) {
    $dataalumni = cari_dataalumni($_POST["keyword"]);
}
...
<head>
    ...
    <title>Data Alumni | Staff Admin</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="p-2" style="background-color: white;">
                        <h3 class="pl-2 pt-2" style="color: black;">Data Alumni</h3>
                        <hr>
                        <div class="pl-2" style="background-color: white;">
                            <a class="btn btn-primary" href="../CRUD/cetak_dataalumni.php" target="_blank"><i class="fas fa-print"></i> Data Alumni</a>
                            <br><br>
                        </div>
                            ...
                            <thead>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-info" href="../CRUD/cetak_detailalumni.php?nik=<?= $row["nik"]; ?>" target="_blank"><i class="fas fa-print"></i></a>
                                            <a class="btn btn-danger" href="../CRUD/hapus_dataalumni.php?nik=<?= $row["nik"]; ?>" onclick="return confirm('Yakin Ingin Menghapus ?');"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
