...
$akunalumni = query("SELECT * FROM akun ORDER BY username ASC");

if (isset($_POST["cari"])) {
    $akunalumni = cari_akunalumni($_POST["keyword"]);
}
...
<head>
    ...
    <title>Akun Alumni | Staff Admin</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="p-2" style="background-color: white;">
                        <h3 class="pl-2 pt-2" style="color: black;">Akun Alumni</h3>
                        <hr>
                        <div class="pl-2" style="background-color: white;">
                            <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#tambah_alumni"><i class="fas fa-plus"></i> Akun Alumni</a>
                            <br><br>
                        </div>
                            ...
                            <thead>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $row["username"]; ?></td>
                                        <td><?= $row["password"]; ?></td>
                                        <td><a class="btn btn-warning" href="#" data-toggle="modal" data-target="#ubah_alumni<?= $row["nik"]; ?>"><i class="far fa-edit"></i></a>
                                            <a class="btn btn-danger" href="../CRUD/hapus_akunalumni.php?nik=<?= $row["nik"]; ?>" onclick="return confirm('Yakin Ingin Menghapus ?');"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
                        ...
                        ?>
                            ...
                            <div class="example-modal">
                                <div id="ubah_alumni<?= $row["nik"]; ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h3 style="color:black; margin-left:95px;">Ubah Akun Alumni</h3>
                                            </div>
                                            <div class="modal-body">
                                                <form action="../CRUD/ubah_akunalumni.php" method="POST">
                                                    <?php
                                                    $nik = $row["nik"];
                                                    $akunalumni = query("SELECT * FROM akun WHERE nik = $nik")[0];
                                                    ?>
                                                    <table class="ml-5">
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td><input type="text" name="username" value="<?= $akunalumni["username"]; ?>"></td>
                                                            <!-- <td><input type="hidden" name="username" value="<?= $akunalumni["username"]; ?>"></td> -->
                                                        </tr>
                                                        <tr>
                                                            <td><label for="password">Password</label></td>
                                                            <td>:</td>
                                                            <td><input type="text" name="password" value="<?= $akunalumni["password"]; ?>" required></td>
                                                        </tr>
                                                        <br>
                                                        <tr>
                                                            <td></td>
                        ...
                        <!-- tambah akun alumni -->
                        <div class="example-modal">
                            <div id="tambah_alumni" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 style="color:black; margin-left:95px;">Tambah Akun Alumni</h3>
                                        </div>
                                        <div class="modal-body">
                                            <form action="../CRUD/tambah_akunalumni.php" method="POST">
                                                <table class="ml-5">
                                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="password" ></td>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td></td>
                                                        <td><button class="btn btn-primary mt-3" type="submit" name="submit">Tambah Akun</button></td>
                                                    </tr>
                                                </table>
                                            </form>
                                        </div>
