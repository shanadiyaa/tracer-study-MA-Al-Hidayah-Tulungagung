...
$kuesioner_alumni = query("SELECT kuesioner_pekerjaan.nik, data_alumni.nim, data_alumni.nama, data_alumni.jurusan_alumni,
data_alumni.prodi_alumni FROM data_alumni INNER JOIN kuesioner_pekerjaan ON 
kuesioner_pekerjaan.nik = data_alumni.nik ORDER BY nama ASC");

if (isset($_POST["cari"])) {
    $kuesioner_alumni = cari_kuesioneralumni($_POST["keyword"]);
}
...
<head>
    ...
    <title>Data Kuesioner Alumni | Staff Admin</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="p-2" style="background-color: white;">
                        <h3 class="pl-2 pt-2" style="color: black;">Data Kuesioner Alumni</h3>
                        <hr>
                        <div class="pl-2" style="background-color: white;">
                            <a class="btn btn-primary" href="../CRUD/cetak_datakuesioner.php" target="_blank"><i class="fas fa-print"></i> Data Kuesioner</a>
                            <br><br>
                        </div>
                        <table class="table table-striped table-bordered" style="color: Black;" cellpadding="10" cellspacing="0">
                            <thead>
                                ...
                                <?php $i = 1; ?>
                                <?php foreach ($kuesioner_alumni as $row) :
                                ?>
                                    <tr>
                                        <td><?= $i; ?></td>
                                        <td><?= $row["nim"]; ?></td>
                                        ...
                                        <td><a class="btn btn-info" href="../CRUD/cetak_kuesioner_alumni.php?nik=<?= $row["nik"]; ?>" target="_blank"><i class="fas fa-print"></i></a>
                                            <a class="btn btn-danger" href="../CRUD/hapus_datakuesioner.php?nik=<?= $row["nik"]; ?>" onclick="return confirm('Yakin Ingin Menghapus ?');"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
